...
describe('Core_datachange', () => {
  ...
  it('should call onChange callback', () => {
    ...
    //expect(messages.res).toEqual(undefined);
    // expect(messages[]).toEqual(col_id); // col_id
    // expect(messages[]).toEqual('test');
    // weryfikacja czy doszlo do mocka
    // var messages = get /messages
    // expect (gdzies w messages jest post /update za danymi z testu, sparwdzamy czy newValue = "Test" i czy col id oraz row id === meta cel_id oraz meta row_id )
    // expect meta col_id meta row_id nie puste
  });
